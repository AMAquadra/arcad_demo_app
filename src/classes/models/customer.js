export class Customer {
    ...
    static getErrors(customer) {
        ...
        } else if (customer.city.length > 30) {
        ...
        } else if (customer.zipCode.length > 10) {
